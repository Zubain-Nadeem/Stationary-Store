...
const Collections = () => (
  <section className="py-10">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      {cats.map(c => (
        <a key={c.label} href="#" className={`flex items-center gap-3 rounded-2xl border border-[color:var(--lavender)]/40 ${c.color} px-4 py-4 shadow-[0_10px_30px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 transition-transform`}>
